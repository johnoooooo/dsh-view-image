...
const DEFAULT_PROMPT =
	"完整描述图片中所有内容，包括所有文字（原样提取，不翻译）、图形和布局结构。Describe the image in full, including all text (extract verbatim, do not translate), figures, and layout. Answer in the same language as the user.";
	...
	ctx.tools.register(
		defineTool({
			...
			async execute(args, exec) {
				...
				const prompt = `${effectiveIntent}\n\nAnalyze the image according to the requirements above.`;
